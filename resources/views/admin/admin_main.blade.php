            ...
            <div class="container">
                <div class="row justify-content-center">                   
                    <div class="col-3">
                        ...
                        <h4>Business</h4>
                            <div class="list-group">                           
                                <a href="{{ route('admin.categories') }}" class="list-group-item {{ request()->is('admin/business/categories*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-layer-group"></i> Categories
                                </a>                         
                                <a href="{{ route('admin.details') }}" class="list-group-item {{ request()->is('admin/business/details*') ? 'active' : '' }}">
